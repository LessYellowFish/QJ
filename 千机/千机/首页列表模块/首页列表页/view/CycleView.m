...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame])
    {
        ...
        UIColor *grayColor =  [UIColor colorWithRed:195/255.0 green:233/255.0 blue:255/255.0 alpha:1];
        ...
        [gradientLayer setColors:[NSArray arrayWithObjects:
                                  (id)[RYUIColorWithRGB(26, 155, 232) CGColor],
                                  (id)[RYUIColorWithRGB(26, 155, 232) CGColor], nil]];// 颜色分配
